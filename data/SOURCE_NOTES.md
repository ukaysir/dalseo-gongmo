...
- 교통통제·혼잡으로 인한 이동 지연 가능성
- 공영주차장·생활주차 수요로 인한 주차 혼잡 가능성
- 무더위쉼터·복지시설 이용 가능 여부
- 공공시설 행사·방문객 증가에 따른 접근·주차 변화
- 학교·전통시장 주변 보행 안전 확인 항목
- 하천·산업단지 주변 소음·악취 등 생활환경 확인 항목
- 전통시장·지역행사에 따른 보행·주차·소음 변화
- 통학로·어린이보호구역 안전 확인 항목
- 경로당·무더위쉼터·복지시설 접근성 확인 항목
- 공공시설·문화시설 방문 혼잡 가능성
- 개발행위허가·도시계획에 따른 생활도로·상권 변화
- 계약현황 기반 공사·정비 일정 확인 항목
- CCTV·노인보호구역 기반 생활안전 확인 항목
- 보건소·의료기관·심야약국 이용 정보 확인 항목
